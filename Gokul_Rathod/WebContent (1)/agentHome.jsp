		  ...
		  <div class="container">
			 <div class="top-nav">
						...
						<ul id="nav">
							 ...
							 <li><a href="#section-3">Tours</a></li>
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
		...
		<ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			<li><span class="filter" data-filter="app"><a href="#1">Add Package</a></span></li>
			<li><span class="filter" data-filter="card"><a href="#2">Update Package</a></span></li>
			<li><span class="filter" data-filter="icon"><a hrer="#3">Remove Pack</a></span></li>
			<li><span class="filter" data-filter="fun"><a href="#4">Show Package</a></span></li>
	    </ul>
		
					 <div id="#1">
							 <form action="insertPack.html">
							  <table>
							  <tr><input type="number" name=pid" placeholder="Id" required="required"></tr>
							  	<tr>
			                    ...
			                    <tr>
							 	...
							 	<tr>
							 		<td><input type="text" placeholder="Image" name="img" required="required"></td>
