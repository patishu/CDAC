...
<title>Journey</title>
<meta charset="utf-8">
<link rel="icon" href="custHome/images/favicon.ico">
<link rel="shortcut icon" href="custHome/images/favicon.ico">
<link rel="stylesheet" href="custHome/css/style.css">
<link rel="stylesheet" href="custHome/css/slider.css">
<script src="custHome/js/jquery.js"></script>
<script src="custHome/js/jquery-migrate-1.1.1.js"></script>
<script src="custHome/js/superfish.js"></script>
<script src="custHome/js/sForm.js"></script>
<script src="custHome/js/jquery.jqtransform.js"></script>
<script src="custHome/js/jquery.equalheights.js"></script>
<script src="custHome/js/jquery.easing.1.3.js"></script>
<script src="custHome/js/tms-0.4.1.js"></script>
<script src="custHome/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="custHome/js/jquery.ui.totop.js"></script>
<script>
...
<header>
  <div class="container_12">
    <div class="grid_12">
      <h1><a href="index.html"><img src="custHome/images/logo.png" alt=""></a></h1>
      <div class="clear"></div>
    </div>
      ...
      <div class="slider-relative">
        <div class="slider-block">
          <div class="slider"> <a href="#" class="prev"></a><a href="#" class="next"></a>
            <ul class="items">
              <li><img src="custHome/images/slide.jpg" alt="">
                <div class="banner">
                  <div>THERE ARE PLENTY OF PLACES</div>
                  <br>
                  <span> that are worth seeing</span> </div>
              </li>
              <li><img src="custHome/images/slide1.jpg" alt=""></li>
              <li><img src="custHome/images/slide2.jpg" alt=""></li>
              <li><img src="custHome/images/slide3.jpg" alt=""></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="content">
    <div class="container_12">
      ...
      <div class="boxes">
        <div class="grid_4">
          <figure>
            <div><img src="custHome/images/page1_img1.jpg" alt=""></div>
            <figcaption>
              <h3>Venice</h3>
        ...
        <div class="grid_4">
          <figure>
            <div><img src="custHome/images/page1_img2.jpg" alt=""></div>
            <figcaption>
              <h3>New York</h3>
        ...
        <div class="grid_4">
          <figure>
            <div><img src="custHome/images/page1_img3.jpg" alt=""></div>
            <figcaption>
              <h3>Paris</h3>
              Lorem ipsum dolor site geril amet, consectetur cing eliti. Suspendisse nulla leo mew dignissim eu velite a rew qw vehicula lacinia arcufasec ro. Aenean lacinia ucibusy fase tortor ut feugiat. Rabi tur oliti aliquam bibendum olor quis malesuadivamu. <a href="#" class="btn">Details</a> </figcaption>
          </figure>
      ...
      <div class="grid_8">
        <div id="tabs">
          ...
          <div class="clear"></div>
          <div class="tab_cont" id="tabs-1"> <img src="custHome/images/page1_img4.jpg" alt="">
            ...
            <img src="custHome/images/page1_img5.jpg" alt="">
            <div class="extra_wrapper">
          ...
          <div class="tab_cont" id="tabs-2"> <img src="custHome/images/page1_img4.jpg" alt="">
            <div class="extra_wrapper">
              <div class="text1">Rem psum dr sit amet. </div>
          ...
          <div class="tab_cont" id="tabs-3"> <img src="custHome/images/page1_img4.jpg" alt="">
            <div class="extra_wrapper">
              <div class="text1">Rem psum dr sit amet. </div>
              <p class="style1">Nulla facilisi. Ut ut tincidunt lacus, ut auctor libero. Duis ommodo vel ipsum sed volutpat. Phasellus a sagittis dui, eu adipiscinget nisiestibulum eutro.</p>
              Nulla facilisi. Ut ut tincidunt lacus, ut auctor libero. Duis ommodo vel ipsum sed volutpat. Phasellus a sagittis dui, eu adipiscinget nisiestibulum eutro. <a href="#" class="btn">Details</a>
